...
/**
 * @author hxk
 * @description 一个序列化的工具类
 *2015年10月29日  下午2:47:19
 */
public class SerializationUtils {
     ...
     * @return
     */
    public static String sessionIdFromString(String value) {
        byte[] content = org.apache.shiro.codec.Base64.decode(value);
        return (String) org.apache.commons.lang3.SerializationUtils.deserialize(content);
    }
